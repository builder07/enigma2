...
#			print "using cached result"
	...
	def has_hdmi(self):
		return (HardwareInfo.device_name == 'dm7020hd' or HardwareInfo.device_name == 'dm800se' or HardwareInfo.device_name == 'dm800' or HardwareInfo.device_name == 'dm800hd' or HardwareInfo.device_name == 'dm500hd' or HardwareInfo.device_name == 'ebox5000' or HardwareInfo.device_name == 'ebox5100' or HardwareInfo.device_name == 'ebox7358' or HardwareInfo.device_name == 'eboxlumi' or (HardwareInfo.device_name == 'dm8000' and HardwareInfo.device_version != None))
